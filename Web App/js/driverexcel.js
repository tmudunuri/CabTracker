...
(function() {
  ...
  function handleDrop(e) {
    ...
    reader.onload = function(e) {
      ...
      for (i in output) {
        console.log("sup");
        var did = output[i].ID, name = output[i].Name, car = output[i].Car;
        function writeDriverData(did, name, car) {
          firebase.database().ref('driverDetailsTest/'+ did).update({
            dname: name,
            car: car
          });
        }
        writeDriverData(did, name, car);
      }
    };
